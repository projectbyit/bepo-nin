...
const hr: Dictionary = {
  meta: {
    ...
    description:
      "Restoran Konoba Bepo Nin — dalmatinska predjela, grill, meso, riba, pašta i deserti u starom gradu Ninu. U sezoni pon–čet 17:00–22:00 h, pet–ned 14:00–22:00 h. Zimi ne radimo (studeni–ožujak). Rezervirajte stol ili se raspitajte za domjenke, pričesti i krizme.",
    keywords: [
      "Restoran Bepo Nin",
      "Konoba Bepo Nin",
    ...
    ogDescription:
      "Priča se nastavlja u Ninu. Grill, meso, riba, pašta i toplina domaćeg stola u starom gradu Ninu. U sezoni pon–čet 17:00–22:00 h, pet–ned 14:00–22:00 h. Zimi zatvoreno (studeni–ožujak).",
  },
  nav: {
    about: "O nama",
    gallery: "Galerija",
  ...
  info: {
    ...
    hoursByDay: [
      { day: "Ponedjeljak", hours: "17:00–22:00 h" },
      { day: "Utorak", hours: "17:00–22:00 h" },
      { day: "Srijeda", hours: "17:00–22:00 h" },
      { day: "Četvrtak", hours: "17:00–22:00 h" },
      { day: "Petak", hours: "14:00–22:00 h" },
      { day: "Subota", hours: "14:00–22:00 h" },
      { day: "Nedjelja", hours: "14:00–22:00 h" },
    ],
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "U sezoni (travanj–listopad) radimo ponedjeljak–četvrtak 17:00–22:00 h, a petak–nedjelja 14:00–22:00 h. Zimi ne radimo — od studenoga do ožujka smo zatvoreni.",
      },
      {
...
const de: Dictionary = {
  ...
  info: {
    ...
    hoursByDay: [
      ...
      { day: "Dienstag", hours: "17:00–22:00" },
      { day: "Mittwoch", hours: "17:00–22:00" },
      { day: "Donnerstag", hours: "17:00–22:00" },
      { day: "Freitag", hours: "14:00–22:00" },
      { day: "Samstag", hours: "14:00–22:00" },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "In der Saison (April–Oktober) sind wir Montag–Donnerstag von 17:00–22:00 und Freitag–Sonntag von 14:00–22:00 geöffnet. Im Winter haben wir geschlossen — von November bis März.",
      },
      {
