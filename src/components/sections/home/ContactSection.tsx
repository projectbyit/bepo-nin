      ...
      <Container className="flex max-w-3xl flex-col gap-6">
        ...
        <div className="pt-2">
          <a
            ...
            className="inline-flex items-center justify-center rounded-md bg-ink px-8 py-3.5 font-serif text-base tracking-[0.06em] uppercase text-surface transition-colors duration-200 ease-out hover:bg-ink/90 active:translate-y-px"
          >
            Booking Table
          </a>
        </div>
